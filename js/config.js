...
const CATEGORY_SIZEINFO = {
  ...
  '여성-반바지': {
    ...
    material: '',
    colCount: 6,
    col1: '허리단면', col2: '밑위', col3: '엉덩이단면', col4: '허벅지단면', col5: '밑단단면', col6: '총장',
    rowCount: 1,
  ...
  '양산': {
    ...
    bgColor: '#faf8ff',
    padding: 32,
    imageUrl: './assets/parasol-diagram.png',
    g1title: '펼쳤을 때 (OPENED)',
    g1count: 3,
    g1r1label: '아크 (ARC)',    g1r1val: '108',  g1r1unit: 'CM',
    g1r2label: '너비 (WIDTH)',  g1r2val: '90',   g1r2unit: 'CM',
    g1r3label: '높이 (HEIGHT)', g1r3val: '55',   g1r3unit: 'CM',
    g2title: '접었을 때 (FOLDED)',
    g2count: 2,
    g2r1label: '길이 (LENGTH)', g2r1val: '30.5', g2r1unit: 'CM',
    g2r2label: '높이 (HEIGHT)', g2r2val: '5',    g2r2unit: 'CM',
    material: '고밀도 폰지 (190T)',
    weight: '약 380g',
  },
};
